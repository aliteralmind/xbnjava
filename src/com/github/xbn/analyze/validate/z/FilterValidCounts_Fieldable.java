 ...
 **/
public interface FilterValidCounts_Fieldable extends GetDebugApbl_Fieldable  {
	FilterCountType getFilterCountType();
	LengthInRange getRange();
	FilterAfterValue getAfterAfterValue();
	FilterAfterValue getBelowAfterValue();
	FilterAfterValue getInAfterValue();
	FilterPreAction getAfterPreAction();
