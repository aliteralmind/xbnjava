...
FUNCTIONS:
   ...
   /&#42;&#42;
      ...
      <p><i>All {@code for[Type](x[])} and {@code for[Type](x[],hnvnb)} functions are derived from {@link #forBooxlean(java.lang.Booxlean[]) forBooxlean(_4TV_Booxlean[])} and {@link #forBooxlean(java.lang.Booxlean[], NullHandlerForPrimitives) forBooxlean(_4TV_Booxlean[],hnvnb)}. <b>Do not edit any functions except the boolean versions.</b></i></p>
