...
public interface Listify<E> extends Collection<E>, Copyable  {
    ...
    * @see  com.github.xbn.array.IndexableUtil#crashIfContainerIsNullAndThatIsBad(com.github.xbn.lang.Null, boolean) CrashIfObject#crashIfContainerIsNullAndThatIsBad(s,s)
