...
/**
   <p>Listifier whose virtual elements are doubles.</p>
 ...
 **/
public interface ListifyDoubleable extends ListifyPrimitiveable<Double>  {
   /**
      <p>Get an element as a {@code double} primitive--{@code null} elements are handled.</p>
    ...
    */
   double getPDouble(int index);
   double[] getPArrayCopyOrNull(NullContainer nnull);
}
