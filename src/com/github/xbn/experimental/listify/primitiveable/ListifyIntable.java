...
/**
   <p>Listifier whose virtual elements are ints.</p>
 ...
 **/
public interface ListifyIntable extends ListifyPrimitiveable<Integer>  {
   /**
      <p>Get an element as a {@code int} primitive--{@code null} elements are handled.</p>
   ...
   int[] getPArrayCopyOrNull(NullContainer nnull);
}
