...
/**
   <P>Listifier whose virtual elements are booleans.</P>

   <P><I>All {@code Listify[Type]} are derived from {@code ListifyBoolable}. <B>Only edit {@code ListifyBoolable}.</B></I></P>
<!--
---nwrq input---
...
Character Char char
   ...
   <P><I>All &#64;code Listify[PrimitiveableType]} are derived from {&#64;link ListifyBooxlable}. <B>Only edit {&#64;code ListifyBooxlable}.</B></I></P>
 -->
...
public interface ListifyBoolable extends ListifyPrimitiveable<Boolean>  {
   /**
      <P>Get an element as a {@code boolean} primitive--{@code null} elements are handled.</P>
   ...
   boolean[] getPArrayCopyOrNull(NullContainer nnull);
}
