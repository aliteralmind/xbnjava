...
/**
 * <p>A single item in a {@code BoundedGrid}.</p>
 *
 * @see  BoundedGrid
 * @since  0.1.4.2
 * author  Copyright (C) 2014, Jeff Epstein ({@code aliteralmind __DASH__ github __AT__ yahoo __DOT__ com}), dual-licensed under the LGPL (version 3.0 or later) or the ASL (version 2.0). See source code for details. <A HREF="http://xbnjava.aliteralmind.com">{@code http://xbnjava.aliteralmind.com}</A>, <A HREF="https://github.com/aliteralmind/xbnjava">{@code https://github.com/aliteralmind/xbnjava}</A>
 */
public class GridItem<O>  {
	private final int horizIdx = -1;
	private final int vertIdx = -1;
	private final O value = null;
	/**
	 * <p>Create a new item from its coordinates and value.</p>
	 * @param  horiz_idx The index of this item within its sub-array. May not be less than zero. Get with {@link #getHorizIndex()}.
	 * @param  vert_idx  The index of this items' sub-array within the overall array. May not be less than zero. Get with {@link #getVertIndex()}.
	 * @param  value     The item. Get with {@link #get()}.
	 */
	public GridItem(int horiz_idx, int vert_idx, O value)  {
		if(horiz_idx < 0)  {
	 ...
	 * {@link #GridItem(int, int, O) constructor}.
	*/
	...
	*/
	 ...
	 * <p>Get the value.</p>
	 *
	 * @return  <code>value</code>, as provided to the
	 * {@link #GridItem(O) constructor}.
	 */
	public O get()  {
		return  value;
	}
