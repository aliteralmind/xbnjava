...
public class DistanceDirection extends AbstractElement  {
	 ...
	 * <br/> &nbsp; &nbsp; <code><i>[end-coord]</i>.{@link MatrixElement#getHorizIndex() getHorizIndex}() - <i>[start-coord]</i>.getHorizIndex()</code>
	 * @param  vert_away  The difference between the start and end
	 * elements' vertical values. Specifically,
	 * <br/> &nbsp; &nbsp; <code><i>[end-coord]</i>.{@link MatrixElement#getVertIndex() getVertIndex}() - <i>[start-coord]</i>.getVertIndex()</code>
