...
/**
   <P>For <A HREF="{@docRoot}/com/github/xbn/chain/Needable.html#indirect">indirectly</A> configuring a {@link com.github.xbn.linefilter.TextLineFilter TextLineFilter}.</P>
...
//self-returners...START
   /**
      ...
      <P>This calls<OL>
         <LI>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder super}.{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#reset() reset}{@code ()}</LI>
         <LI>{@link #resetTLMCFN() resetTLMCFN}{@code ()}</LI>
      </OL></P>
   ...
   /**
      ...
      <P>Equal to
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder super}.{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#blockMarksInclusive() blockMarksInclusive}()</CODE></P>
   ...
   /**
      ...
      <P>Equal to
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder super}.{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#blockMarksExclusive() blockMarksExclusive}()</CODE></P>
   ...
   /**
      ...
      <P>Equal to
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder super}.{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#blockMarksInclusive(boolean) blockMarksInclusive}(are_inclusive)</CODE></P>
   ...
   /**
      ...
      <P>This sets<UL>
         <LI>The {@link com.github.xbn.linefilter.LineFilter#getAlterStart() start-alterer} to
         <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.NewTextLineAltererFor NewTextLineAltererFor}.{@link com.github.xbn.linefilter.NewTextLineAltererFor#text(ValueValidator) text}(validator)</CODE>
         ...
         <LI>The {@link com.github.xbn.linefilter.LineFilter#getAlterStart() end-alterer} with the same (kind of) object, but with the literal term <CODE>&quot;**<!--->/&quot;</CODE> (block-end is {@link #isEndRequired() required})</LI>
      </UL></P>
   ...
   /**
      ...
      <P>This sets the {@link com.github.xbn.linefilter.LineFilter#getAlterLine() line-alterer} to
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.NewTextLineAltererFor NewTextLineAltererFor}.{@link com.github.xbn.linefilter.NewTextLineAltererFor#text(ValueValidator) text}(validator)</CODE>
      <BR>Where {@code validator} is equal to
   ...
   /**
      ...
      <P>This sets<UL>
         <LI>{@link com.github.xbn.linefilter.LineFilter#getAlterEnd() getAlterEnd}{@code ()}* to
         <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.AdaptRegexReplacerTo AdaptRegexReplacerTo}.{@link com.github.xbn.linefilter.AdaptRegexReplacerTo#lineReplacer(RegexReplacer, ValidResultFilter) lineReplacer}(<I>[the-configured-RegexReplacer]</I>, filter)</CODE></LI>
         <LI>{@link com.github.xbn.linefilter.LineFilter#isEndRequired() isEndRequired}{@code ()} to {@code true}</LI>
      </UL></P>
   ...
   /**
      ...
      <P>This sets<UL>
         <LI>{@link com.github.xbn.linefilter.LineFilter#getAlterEnd() getAlterEnd}{@code ()}* to
         <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.AdaptRegexReplacerTo AdaptRegexReplacerTo}.{@link com.github.xbn.linefilter.AdaptRegexReplacerTo#lineReplacer(RegexReplacer, ValidResultFilter) lineReplacer}(<I>[the-configured-RegexReplacer]</I>, filter)</CODE></LI>
         <LI>{@link com.github.xbn.linefilter.LineFilter#isEndRequired() isEndRequired}{@code ()} to {@code false}</LI>
      </UL></P>
   ...
   /**
      ...
      <P>This sets {@link com.github.xbn.linefilter.LineFilter#getAlterLine() getAlterLine}{@code ()}* to
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.AdaptRegexReplacerTo AdaptRegexReplacerTo}.{@link com.github.xbn.linefilter.AdaptRegexReplacerTo#lineReplacer(RegexReplacer, ValidResultFilter) lineReplacer}(<I>[the-configured-RegexReplacer]</I>, filter)</CODE></P>
   ...
   /**
      ...
      <P>This sets {@link com.github.xbn.linefilter.LineFilter#getAlterStart() getAlterStart}{@code ()}* to
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.NewTextLineAltererFor NewTextLineAltererFor}.{@link com.github.xbn.linefilter.NewTextLineAltererFor#text(ValueValidator) text}(<I>[the-configured-RegexValidator]</I>, null)</CODE></P>
   ...
   /**
      ...
      <P>This sets<UL>
         <LI>{@link com.github.xbn.linefilter.LineFilter#getAlterEnd() getAlterEnd}{@code ()}* to
         <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.NewTextLineAltererFor NewTextLineAltererFor}.{@link com.github.xbn.linefilter.NewTextLineAltererFor#text(ValueValidator) text}(<I>[the-configured-RegexValidator]</I>, null)</CODE></LI>
         <LI>{@link com.github.xbn.linefilter.LineFilter#isEndRequired() isEndRequired}{@code ()} to {@code true}</LI>
      </UL></P>
   ...
   /**
      ...
      <P>The sets {@link com.github.xbn.linefilter.LineFilter LineFilter}.{@link com.github.xbn.linefilter.LineFilter#getAlterStart() getAlterStart}{@code ()}* to the </P>
   ...
   /**
      ...
      <P>Equal to
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder super}.{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#start(ValueAlterer) start}(alterer)</CODE></P>
   ...
   /**
      ...
      <P>Equal to
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder super}.{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#end(BlockEnd, ValueAlterer) end}(end_is, alterer)</CODE></P>
   ...
   /**
      ...
      <P>Equal to
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder super}.{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#line(ValueAlterer) line}(alterer)</CODE></P>
   ...
   /**
      ...
      <P>Equal to
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder super}.{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#noSubModes() noSubModes}()</CODE></P>
   ...
   /**
      ...
      <P>Equal to
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder super}.{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#setSubModes(LineFilter[]) setSubModes}(sub_modes)</CODE></P>
   ...
   /**
      ...
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.AdaptRegexReplacerTo AdaptRegexReplacerTo}.{@link com.github.xbn.linefilter.AdaptRegexReplacerTo#lineReplacer(Pattern, String, ReplacedInEachInput, ValidResultFilter, Appendable) lineReplacer}(pattern_toFind, direct_rplcWith, rplcWhat_notMatchNums, filter_ifNullOff, dbgDest_ifNonNull)</CODE>
   ...
   /**
      ...
      @return  <CODE>{@link #start(ValueAlterer) start}(txtLineAlterer)</CODE>
      <BR>Where {@code txtLineAlterer} is equal to
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.NewTextLineAltererFor NewTextLineAltererFor}.{@link com.github.xbn.linefilter.NewTextLineAltererFor#text(Pattern, ValidResultFilter, Appendable) text}(pattern_toFind, filter_ifNullOff, dbgDest_ifNonNull)</CODE>
      @see  #end(BlockEnd, Pattern, ValidResultFilter, Appendable) end
   ...
   /**
      ...
      <P>Equal to
      <BR> &nbsp; &nbsp; <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder super}.{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#debugTo(Appendable) debugTo}(dest_ifNonNull)</CODE></P>
...
//self-returners...END
   ...
   /**
      ...
      @return  <CODE>(M)(new {@link com.github.xbn.linefilter.TextLineFilter#TextLineFilter(LineFilter_Fieldable) TextLineFilter}(this))</CODE>
    **/
   public M build()  {
