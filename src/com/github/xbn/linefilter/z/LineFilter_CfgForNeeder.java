...
package  com.github.xbn.linefilter.z;
   ...
   import  com.github.xbn.linefilter.LineFilter;
   import  com.github.xbn.linefilter.LineObject;
   import  java.util.Arrays;
/**
   <P>For <A HREF="{@docRoot}/com/github/xbn/chain/Needable.html#indirect">indirectly</A> configuring a {@link com.github.xbn.linefilter.LineFilter LineFilter}.</P>
...
//constructors...START
   /**
      ...
      <P>Equal to
      <BR> &nbsp; &nbsp; <CODE> <!-- GENERIC PARAMETERS FAIL IN @link --><A HREF="#LineFilter_CfgForNeeder(R, int, java.lang.String)">this</A>(needer, 0, {@link com.github.xbn.linefilter.LineFilter LineFilter}.{@link com.github.xbn.linefilter.LineFilter#DUMMY_NAME_FOR_ROOT_MODE DUMMY_NAME_FOR_ROOT_MODE})</CODE></P>
    **/
   ...
   /**
      ...
      <P>This<OL>
         ...
         <LI>Sets {@link com.github.xbn.linefilter.LineFilter#getSubLevel() getSubLevel}{@code ()}* to {@code sub_subLevelNum}</LI>
         <LI>Sets {@link com.github.xbn.linefilter.LineFilter#getName() getName}{@code ()}* to {@code name}.</LI>
...
//self-returning setters...START
   ...
   /**
      ...
      @param  alterer  May not be {@code null}. A <I>duplicate</I> of this object is stored. Get with {@link com.github.xbn.linefilter.LineFilter#getAlterStart() getAlterStart}{@code ()}*.
      @return  <I>{@code this}</I>
   ...
   /**
      ...
      </UL>Get with {@link com.github.xbn.linefilter.LineFilter#areBlockMarksInclusive() areBlockMarksInclusive}{@code ()}*
   ...
   /**
      ...
      @return  {@link #end(BlockEnd, ValueAlterer) end}{@code ({@link com.github.xbn.linefilter.z.BlockEnd BlockEnd}.{@link com.github.xbn.linefilter.z.BlockEnd#REQUIRED REQUIRED}, alterer)}
   ...
   /**
      ...
      @return  {@link #end(BlockEnd, ValueAlterer) end}{@code ({@link com.github.xbn.linefilter.z.BlockEnd BlockEnd}.{@link com.github.xbn.linefilter.z.BlockEnd#OPTIONAL OPTIONAL}, alterer)}
   ...
   /**
      ...
      @param  alterer  May not be {@code null}. A <I>duplicate</I> of this object is stored. Get with {@link com.github.xbn.linefilter.LineFilter#getAlterEnd() getAlterEnd}{@code ()}*.
      @param  end_is  May not be {@code null}. If {@code BlockEnd.}{@link com.github.xbn.linefilter.z.BlockEnd#REQUIRED REQUIRED}, the block {@link com.github.xbn.linefilter.LineFilter#isBlockEndLine() end-mark mark} must exist before the next block's {@link com.github.xbn.linefilter.LineFilter#isBlockEndLine() start-mark} is found (or the {@code com.github.xbn.linefilter.LineFilter#declareAllLinesAnalyzed() end of input} is reached). This sets {@link com.github.xbn.linefilter.LineFilter#isEndRequired() isEndRequired}{@code ()}* to <CODE>end_is.{@link com.github.xbn.linefilter.z.BlockEnd#isRequired() isRequired}()</CODE>.
   ...
   /**
      ...
      @param  alterer  May not be {@code null}. A <I>duplicate</I> of this object is stored. Get with {@link com.github.xbn.linefilter.LineFilter#getAlterLine() getAlterLine}{@code ()}*.
      @see  #start(ValueAlterer) start(av)
    **/
   ...
   /**
      ...
      <P>These settings are used only by the {@linkplain com.github.xbn.linefilter.LineFilter#activeLineIterator(Iterator, Appendable) line iterator}. They are ignored by <CODE><!-- GENERIC PARAMETERS FAIL IN @link --><A HREF="{@docRoot}/com/github/xbn/text/line/LineFilter.html#getActiveLine(L)">getActiveLine</A>(L)</CODE>. <I>If <CODE>{@link com.github.xbn.linefilter.LineFilter LineFilter}.{@link com.github.xbn.linefilter.LineFilter#activeLineIterator(Iterator, Appendable) activeLineIterator}</CODE> will not be used, then these settings are ignored.</I></P>

      @param  ifBlk_active  May not be {@code null}. Get with {@link com.github.xbn.linefilter.LineFilter#doKeepBlockActive() doKeepBlockActive}{@code ()}.
      @param  ifLn_active  May not be {@code null}. Get with {@link com.github.xbn.linefilter.LineFilter#doKeepLineActive() doKeepLineActive}{@code ()}.
      @param  if_inactive  May not be {@code null}. Get with {@link com.github.xbn.linefilter.LineFilter#doKeepInactive() doKeepInactive}{@code ()}.
    **/
   ...
   /**
      ...
      @param  sub_modes  May not be {@code null}, and must contain only unique and non-null elements, each having a {@link com.github.xbn.linefilter.LineFilter#getSubLevel() sub-level} equal to <CODE>this.{@link com.github.xbn.linefilter.LineFilter#getSubLevel() getSubLevel}()* + 1</CODE>. If empty, there are no sub-modes. Get with {@link com.github.xbn.linefilter.LineFilter#getSubCount() getSubCount}{@code ()}* and {@link com.github.xbn.linefilter.LineFilter#getSub(String) getSub}{@code (s)}.
      @see  #noSubModes()
    **/
