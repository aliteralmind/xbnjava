...
public class NewBlockEntityFor  {
   /**
      ...
      @return
<BLOCKQUOTE><PRE>{@link #lineRange_Cfg_startEndFilterDebug(String, Pattern, ValidResultFilter, Appendable, Pattern, ValidResultFilter, Appendable, RawEntityOnOffFilter, Appendable) lineRange_Cfg_startEndFilterDebug}(name_ifNonNull,
    ...
    **/
   public static final BlockEntity_CfgForNeeder<?,?> javaComment_Cfg_startEndDebug(String name_ifNonNull, IncludeJavaDoc java_doc, Appendable dbgStart_ifNonNull, Appendable dbgEnd_ifNonNull, RawEntityOnOffFilter<String,RawLine<String>> filter_ifNonNull, Appendable dbgLineNums_ifNonNull)  {
...
<BLOCKQUOTE><PRE>{@link #lineRange_Cfg_startEndFilterDebug(String, Pattern, ValidResultFilter, Appendable, Pattern, ValidResultFilter, Appendable, RawEntityOnOffFilter, Appendable) lineRange_Cfg_startEndFilterDebug}(name_ifNonNull,
    ...
    **/
   public static final BlockEntity_CfgForNeeder<?,?> javaDocComment_Cfg_startEndFilterDebug(String name_ifNonNull, Appendable dbgStart_ifNonNull, Appendable dbgEnd_ifNonNull, RawEntityOnOffFilter<String,RawLine<String>> filter_ifNonNull, Appendable dbgLineNums_ifNonNull)  {
      return  lineRange_Cfg_startEndFilterDebug(name_ifNonNull,
...
<BLOCKQUOTE><PRE>new {@link com.github.xbn.linefilter.entity.z.BlockEntity_Cfg#BlockEntity_Cfg(String) BlockEntity_Cfg}(name_ifNonNull).
   ...
   /**
      ...
      @return
<BLOCKQUOTE><PRE>{@link #lineRange(String, KeepStartLine, KeepMidLines, KeepEndLine, Pattern, ValidResultFilter, Appendable, Pattern, ValidResultFilter, Appendable, RawEntityOnOffFilter, Appendable) lineRange}(name_ifNonNull,
...
<BLOCKQUOTE><PRE>{@link #lineRange_Cfg_startEndFilterDebug(String, Pattern, ValidResultFilter, Appendable, Pattern, ValidResultFilter, Appendable, RawEntityOnOffFilter, Appendable) lineRange_Cfg_startEndFilterDebug}(name_ifNonNull,
   ...
   build()
      ...
      @see  #lineRange(String, KeepMatched, Pattern, ValidResultFilter, Appendable, Pattern, ValidResultFilter, Appendable, RawEntityOnOffFilter, Appendable)
    **/
...
<BLOCKQUOTE><PRE>new {@link com.github.xbn.linefilter.entity.z.BlockEntity_Cfg#BlockEntity_Cfg(String) BlockEntity_Cfg}(
   ...
   {@link com.github.xbn.linefilter.entity.z.BlockEntity_CfgForNeeder#debugLineNumbers(Appendable) debugLineNumbers}(dbgLineNums_ifNonNull)</PRE></BLOCKQUOTE>
      ...
      @see  #lineRangeWithReplace(String, KeepStartLine, KeepMidLines, KeepEndLine, Pattern, String, ReplacedInEachInput, ValidResultFilter, Appendable, ValueAlterer, Pattern, String, ReplacedInEachInput, ValidResultFilter, Appendable, RawEntityOnOffFilter, Appendable) lineRangeWithReplace(...,KeepStartLine, KeepMidLines, KeepEndLine,...)
    **/
   ...
   /**
      ...
      @return
<BLOCKQUOTE><PRE>{@link #lineRangeWithReplace(String, KeepStartLine, KeepMidLines, KeepEndLine, Pattern, String, ReplacedInEachInput, ValidResultFilter, Appendable, ValueAlterer, Pattern, String, ReplacedInEachInput, ValidResultFilter, Appendable, RawEntityOnOffFilter, Appendable) lineRangeWithReplace}(name_ifNonNull,
   {@link KeepStartLine}.{@link KeepStartLine#getForKeepMatched(KeepMatched, String) getForKeepMatched}(keep_all, ...),
   {@link KeepMidLines}.{@link KeepMidLines#getForKeepMatched(KeepMatched, String) getForKeepMatched}(keep_all, ...),
   {@link KeepEndLine}.{@link KeepEndLine#getForKeepMatched(KeepMatched, String) getForKeepMatched}(keep_all, ...),
   start_ptrn, start_rplcWith, startRplcWhat_notMatchNums,
   ...
   endPtrn_ifNonNull, end_rplcWith, endRplcWhat_notMatchNums,
      null, dbgEnd_ifNonNull,
   dbgLineNums_ifNonNull)</PRE></BLOCKQUOTE>
      @see  #lineRangeWithReplace(String, KeepStartLine, KeepMidLines, KeepEndLine, Pattern, String, ReplacedInEachInput, ValidResultFilter, Appendable, ValueAlterer, Pattern, String, ReplacedInEachInput, ValidResultFilter, Appendable, RawEntityOnOffFilter, Appendable) lineRangeWithReplace(String, KeepStartLine, ...)
    **/
...
<BLOCKQUOTE><PRE>{@link #lineRange_Cfg_startEndFilterDebug(String, Pattern, ValidResultFilter, Appendable, Pattern, ValidResultFilter, Appendable, RawEntityOnOffFilter, Appendable) lineRange_Cfg_startEndFilterDebug}(name_ifNonNull,
   ...
   build()</PRE></BLOCKQUOTE>
      @see  #lineRangeWithReplace(String, KeepMatched, Pattern, String, ReplacedInEachInput, ValidResultFilter, Appendable, ValueAlterer, Pattern, String, ReplacedInEachInput, ValidResultFilter, Appendable, RawEntityOnOffFilter, Appendable) lineRangeWithReplace(String, KeepMatched, ...)
    **/
...
<BLOCKQUOTE><PRE>new {@link com.github.xbn.linefilter.entity.z.BlockEntity_Cfg#BlockEntity_Cfg(String) BlockEntity_Cfg}(name_ifNonNull).
   {@link com.github.xbn.linefilter.entity.z.BlockEntity_CfgForNeeder#keepStartMidEnd(boolean, boolean, boolean) keepStartMidEnd}(
      ...
      @see  #keepAllUnchanged(String, RawEntityOnOffFilter, Appendable)
    ...
    **/
   public static final BlockEntity_CfgForNeeder<?,?> returnKeptUnchanged_Cfg_keepFilterDebug(String name_rootIfNull, KeepStartLine keep_start, KeepMidLines keep_mids, KeepEndLine keep_end, RawEntityOnOffFilter<String,RawLine<String>> filter_ifNonNull, Appendable dbgLineNums_ifNonNull)  {
      try  {
   ...
   /**
      ...
      @return
<BLOCKQUOTE><PRE>{@link #returnKeptUnchanged_Cfg_keepFilterDebug(String, KeepStartLine, KeepMidLines, KeepEndLine, RawEntityOnOffFilter, Appendable) returnKeptUnchanged_Cfg_keepFilterDebug}(name_rootIfNull,
    ...
    **/
   public static final BlockEntity keepAllUnchanged(String name_rootIfNull, RawEntityOnOffFilter<String,RawLine<String>> filter_ifNonNull, Appendable dbgLineNums_ifNonNull)  {
