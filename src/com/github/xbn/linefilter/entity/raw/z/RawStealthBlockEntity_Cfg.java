 ...
 **/
public class RawStealthBlockEntity_Cfg<O,L extends RawLine<O>> extends RawStealthBlockEntity_CfgForNeeder<O,L,RawStealthBlockEntity<O,L>,DummyForNoNeeder>   {
   /**
