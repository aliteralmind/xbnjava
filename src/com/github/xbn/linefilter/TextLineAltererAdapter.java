 ...
 **/
public interface TextLineAltererAdapter<E> extends ValueAlterer<LineObject<String>,String>, Adapter<E>, TextLineAlterer  {
   @Override
   TextLineAltererAdapter<E> getObjectCopy();
}
