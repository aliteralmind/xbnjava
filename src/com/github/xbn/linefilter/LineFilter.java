...
/**
   ...
   <a name="cfg"/><H3>Builder Configuration: {@link com.github.xbn.linefilter.z.LineFilter_Cfg LineFilter_Cfg}</H3>

   <P><UL>
      <LI><B>Block:</B><UL>
         <LI><B>Inclusivity:</B> {@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#blockMarksExclusive() blockMarksExclusive}{@code ()}, {@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#blockMarksExclusive() blockMarksExclusive}{@code ()}, {@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#blockMarksInclusive(boolean) blockMarksInclusive}{@code (b)}</LI>
         <LI><CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#start(ValueAlterer) start}(av)</CODE></LI>
         <LI><CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#end(BlockEnd, ValueAlterer) end}(be, av)</CODE></LI>
      </UL></LI>
      <LI><B>Line and sub-modes:</B> <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#line(ValueAlterer) line}(av)</CODE>, {@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#blockMarksExclusive() blockMarksExclusive}{@code ()}, <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#setSubModes(LineFilter[]) setSubModes}(blm)</CODE></LI>
      <LI><B>Other:</B> {@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#ifBlockOrLineOrNotActive(ActiveBlockLines, ActiveSingleLines, InactiveLines) ifBlockOrLineOrNotActive}{@code (iba,ila,iia)}, <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#debugTo(Appendable) debugTo}(apbl)</CODE>, <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#extraErrInfo(Object) extraErrInfo}(o)</CODE>, {@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#blockMarksExclusive() blockMarksExclusive}{@code ()}, <CODE>{@link com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#chainID(boolean, Object) chainID}(b,o)</CODE></LI>
   </UL></P>
...
//public
   ...
   /**
      ...
      @see  #doKeepInactive()
      @see  com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#ifBlockOrLineOrNotActive(ActiveBlockLines, ActiveSingleLines, InactiveLines)
    **/
   public boolean doKeepBlockActive()  {
      return  doKeepBlkActv;
   }
   /**
      <P>Should lines that are single-line entities be kept?. This setting is used only by the {@linkplain com.github.xbn.linefilter.LineFilter#activeLineIterator(Iterator, Appendable) line iterator}.</P>
   ...
   /**
      <P>Should lines that are not part of a block, and not a single-line entity be kept?. This setting is used only by the {@linkplain com.github.xbn.linefilter.LineFilter#activeLineIterator(Iterator, Appendable) line iterator}.</P>
   ...
   /**
      ...
      @see  #isLineActive()
      @see  #iterator()
      @see  com.github.xbn.linefilter.LineObjectIterator
    **/
...
//					" - getAlterEnd(): " + getAlterEnd(), getExtraErrInfo()));
   ...
   /**
      ...
      @see  com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#start(ValueAlterer) LineFilter_Cfg#start(av)
      @see  #getAlterEnd()
      @see  #getAlterLine()
   ...
   /**
      ...
      @see  com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#end(BlockEnd, ValueAlterer) LineFilter_Cfg#end(av,b)
      @see  #getAlterStart()
      @see  #isEndRequired()
    **/
   ...
   /**
      ...
      @see  com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#blockMarksInclusive()
      @see  com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#blockMarksExclusive()
    **/
   ...
   /**
      ...
      @see  com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#line(ValueAlterer) LineFilter_Cfg#line(av)
      @see  #getAlterStart()
    **/
...
try  {
   ...
   /**
      ...
      @see  #getSubCount()
      @see  com.github.xbn.linefilter.z.LineFilter_CfgForNeeder#setSubModes(LineFilter[]) CfgForNeeder#setSubModes(blm[])
    **/
   ...
   /**
      ...
      @param  line_obj  May not be {@code null}, and its {@link com.github.xbn.linefilter.LineObject#getNumber() line number} must be greater than ({@link #getLineNumber() getLineNumber}{@code ()}.
      @return  If {@code line_obj} is a<UL>
         <LI>{@link #isBlockStartLine() the first line in a block}:
         <BR> &nbsp; &nbsp; <CODE>{@link #getAlterStart() getAlterStart}().<!-- GENERIC PARAMETERS FAIL IN @link --><A HREF="{@docRoot}/com/github/xbn/analyze/alter/ValueAlterer.html#getAltered(V, A)">getAltered</A>(line_obj, line_object.{@link com.github.xbn.linefilter.LineObject#getBody() getBody}())</CODE></LI>
