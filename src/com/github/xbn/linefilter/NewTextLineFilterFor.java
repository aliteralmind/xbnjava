...
public class NewTextLineFilterFor  {
   /**
      ...
      @return  <CODE>new {@link com.github.xbn.linefilter.z.TextLineFilter_Cfg#TextLineFilter_Cfg() TextLineFilter_Cfg}().{@link com.github.xbn.linefilter.z.TextLineFilter_CfgForNeeder#debugTo(Appendable) debugTo}(debug_ifNonNull).{@link com.github.xbn.linefilter.z.TextLineFilter_CfgForNeeder#build() build}()</CODE>
    **/
   ...
   /**
      ...
      @return  <PRE>new {@link com.github.xbn.linefilter.z.TextLineFilter_Cfg#TextLineFilter_Cfg() TextLineFilter_Cfg}.
   {@link com.github.xbn.linefilter.z.TextLineFilter_CfgForNeeder#start(Pattern, ValidResultFilter, Appendable) start} (start_ptrn, null, dbgStart_ifNonNull).
   {@link com.github.xbn.linefilter.z.TextLineFilter_CfgForNeeder#end(BlockEnd, Pattern, ValidResultFilter, Appendable) end}({@link com.github.xbn.linefilter.z.BlockEnd BlockEnd}.{@link com.github.xbn.linefilter.z.BlockEnd#REQUIRED REQUIRED}, end_ptrn, null, dbgEnd_ifNonNull).
   blockMarksInclusive(block_marksAre.{@link com.github.xbn.linefilter.BlockMarks#areInclusive() inclusive}()).
   ifBlockOrLineOrNotActive({@link com.github.xbn.linefilter.z.ActiveBlockLines ActiveBlockLines}.{@link com.github.xbn.linefilter.z.ActiveBlockLines#KEEP KEEP}, {@link com.github.xbn.linefilter.z.ActiveSingleLines ActiveSingleLines}.{@link com.github.xbn.linefilter.z.ActiveSingleLines#DISCARD DISCARD}, {@link com.github.xbn.linefilter.z.InactiveLines InactiveLines}.{@link com.github.xbn.linefilter.z.InactiveLines#DISCARD DISCARD}).
   {@link com.github.xbn.linefilter.z.TextLineFilter_CfgForNeeder#debugTo(Appendable) debugTo}(dbgMode_ifNonNull).{@link com.github.xbn.linefilter.z.TextLineFilter_CfgForNeeder#build() build}();</PRE>
    **/
...
{@.file.textlet com\\github\\xbn\\examples\\linefilter\\doc-files\\BetweenTwoLinesWithReplaceXmpl_input.txt}

{@.codelet.and.out com.github.xbn.examples.linefilter.BetweenTwoLinesWithReplaceXmpl("examples\\com\\github\\xbn\\examples\\linefilter\\doc-files\\BetweenTwoLinesWithReplaceXmpl_input.txt"):eliminateCmtBlocksPkgLineAndPkgReferences(true, true, false)}
