...
/**
   <P>{@code java com.github.xbn.examples.lang.functor.WriterForAppendableWBoolCnstrChecks}</P>

   @author  Copyright (C) 2014, Jeff Epstein, dual-licensed under the LGPL (version 3.0 or later) or the ASL (version 2.0). See source code for details. <A HREF="http://xbnjava.aliteralmind.com">{@code http://xbnjava.aliteralmind.com}</A>, <A HREF="https://github.com/aliteralmind/xbnjava">{@code https://github.com/aliteralmind/xbnjava}</A>
 **/
public class WriterForAppendableWBoolCnstrChecks extends Writer  {
   public static final void main(String[] ignored)  {
      Writer wrtr = new WriterForAppendableWBoolCnstrChecks(System.out);
      try  {
         wrtr.append("Hello");
         wrtr.close();
   ...
   public WriterForAppendableWBoolCnstrChecks(Appendable apbl)  {
