...
/**
   <P>Uses {@code com.github.xbn.linefilter.TextLineFilter} to alter the sub-mode lines contained in a Java source-code file, and otherwise print the source-code unchanged.</P>

   <P>{@code java com.github.xbn.examples.linefilter.OutputSourceHighlightSubModeXmpl xbn\examples\text\line\FindJavaDocBlocksAndSLCmtsWSubModes_input.txt}</P>
