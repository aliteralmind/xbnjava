...
/**
   <P>Uses {@code com.github.xbn.linefilter.TextLineFilter} to find (the line numbers of) all JavaDoc blocks and single-line comments within a Java source-code file--this also detects sub-modes that may be contained within each JavaDoc block (output occurs automatically, via <CODE>LineFilter</CODE> debugging).</P>

   <P>{@code java com.github.xbn.examples.linefilter.FindJavaDocBlocksAndSLCmtsWSubModesXmpl xbn\examples\text\line\FindJavaDocBlocksAndSLCmtsWSubModes_input.txt}</P>
