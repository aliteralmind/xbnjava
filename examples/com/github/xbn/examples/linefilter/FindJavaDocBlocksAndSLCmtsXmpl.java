...
/**
   <P>Uses {@code com.github.xbn.linefilter.}{@link com.github.xbn.linefilter.TextLineFilter TextLineFilter} to find (the line numbers of) all JavaDoc blocks and single line comments in a Java source-code file (output is manually generated).</P>

   <P>{@code java com.github.xbn.examples.linefilter.FindJavaDocBlocksAndSLCmtsXmpl xbn\examples\text\line\FindJavaDocBlocksAndSLCmtsWSubModes_input.txt}</P>
